...
class CodeServiceAsync:
    ...
    async def _safe_run_wrapper(self, args):
        ...
        async with sema:
            #print("[RUN FUNCTION START]", flush=True)
    ...
    async def queue_push(self, format_, code1, code1_language, code2, code2_language, time_limit, repeat_count):
        ...
        while repeat_count:
            ...
            repeat_count -= pushed
            #print("[PUSHEEEED]", flush=True)

        #print("[WAIT]", flush=True)
        res = await tracker.future
    ...
    async def run(self, account_id, format_, code1, code2, time_limit, repeat_count, tracker):
        ...
        async for tc in tc_client.testcase_generate(account_id, format_, repeat_count):
            ...
            #print("[CODE RUN ENDDDDD]", flush=True)
            ...
            if code1_exitcode != code2_exitcode:
                ...
                #print("[SHOULD NOT HERE]", flush = True)
